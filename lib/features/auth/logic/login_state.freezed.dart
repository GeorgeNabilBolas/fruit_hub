...
class _LoginLoading extends LoginState {
   _LoginLoading(): super._();
...
class _LoginSuccess extends LoginState {
   _LoginSuccess(this.user): super._();
...
class _LoginFailure extends LoginState {
   _LoginFailure(this.message): super._();
