...
class AppSizes {
  ...
  static const paddingSymmetricH4 = EdgeInsets.symmetric(horizontal: AppSizes.p4);
  static const paddingSymmetricH8 = EdgeInsets.symmetric(horizontal: AppSizes.p8);
  static const paddingSymmetricH16 = EdgeInsets.symmetric(horizontal: AppSizes.p16);
  static const paddingSymmetricH20 = EdgeInsets.symmetric(horizontal: AppSizes.p20);
  static const paddingSymmetricH24 = EdgeInsets.symmetric(horizontal: AppSizes.p24);
  static const paddingSymmetricH32 = EdgeInsets.symmetric(horizontal: AppSizes.p32);
  static const paddingSymmetricH38 = EdgeInsets.symmetric(horizontal: AppSizes.p38);
  static const paddingSymmetricH40 = EdgeInsets.symmetric(horizontal: AppSizes.p40);
  static const paddingSymmetricH48 = EdgeInsets.symmetric(horizontal: AppSizes.p48);
